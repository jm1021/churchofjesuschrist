...
Question: Do we expect leaders to `deliver` us?
...
Question: Are we in a land of `inheritance`?
...
Question: Do we see the `temples` as a latter-day blessing?  Or do we have anything that compares to that generation of the `church of Christ`?
...
Qustion: How is `believing the manifested` in your life?
...
Question: What does `daily` repentance look like in your life?
